...
rm vert.spv
rm frag.spv
javac src\main\java\com\brcolow\game\Vulkan.java src\main\java\com\brcolow\game\VkResult.java src\main\java\com\brcolow\game\WindowProc.java src\main\java\com\brcolow\game\VkPhysicalDeviceType.java -d .\target\classes --source-path .\src\main\java --module-path .\target\classes -target 17 -source 17 -encoding UTF-8 --enable-preview --module-version 0.0.1-SNAPSHOT
